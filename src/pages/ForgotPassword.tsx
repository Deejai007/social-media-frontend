          ...
          <div className="w-full px-8 max-w-lg space-y-6 bg-white rounded-md py-16">
            ...
            >
              ...
              <div>
                <button
                  type="submit"
                  className="w-full px-4 py-2 font-medium text-center text-white bg-ring-indigo-600 transition-colors duration-200 rounded-md bg-indigo-500 hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-1"
                >
                  Send
                </button>
              </div>
            ...
            {isSent && (
              <div className="flex justify-center bg-green-100 p-2 rounded-md text-green-900 flex-row">
                <p className=" ">
                  Email Has been sent! Check you email for further instructions.
                </p>
              </div>
            )}
